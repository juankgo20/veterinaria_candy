      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-light text-dark" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php endif; ?>
            <?php else: ?>
              <a href="./admin" class="mx-2 text-dark">Iniciar Sesión</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=appointment" class="nav-link <?= isset($page) && $page =='appointment' ? "active" : "" ?>">Programar Cita</a>
              </li>
              <li class="nav-item">
                <a href="./?page=services" class="nav-link <?= isset($page) && $page =='services' ? "active" : "" ?>">Nuestros Servicios</a>
              </li>
