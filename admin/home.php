...
?>
<h1>Bienvenido a <?php echo $_settings->info('name') ?> - Panel de Administrador</h1>
...
<div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Solicitud pendiente</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Solicitud confirmada</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Solicitud cancelada</span>
            <span class="info-box-number text-right">
                <?php 
...
<div class="card card-outline card-primary rounded-0 shadow">
    <div class="card-header rounded-0">
            <h4 class="card-title">Solicitudes de cita</h4>
    </div>
    <div class="card-body">
