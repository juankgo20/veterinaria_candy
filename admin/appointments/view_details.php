...
<div class="content py-3">
    <div class="card card-outline card-dark rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title text-primary">Detalles de solicitud de cita</h5>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <div id="outprint">
                    <fieldset>
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tr>
                                        <th class="text-muted text-white bg-gradient-dark px-2 py-1">Código de solicitud de cita</th>
                                        <td><?= ($code) ?></td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Información del propietario</legend>
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="">
                                            ...
                                            <tbody>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Nombre y Apellido</th>
                                                    <td class="py-1 px-2 text-right"><?= ucwords($owner_name) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Contacto #</th>
                                                ...
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Dirección</th>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Información de mascotas</legend>
                                        <table class="table table-stripped table-bordered" data-placeholder='true'>
                                            ...
                                            <tbody>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Tipo de mascota</th>
                                                    <td class="py-1 px-2 text-right"><?= ($pet_type) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Raza de mascota</th>
                                                    <td class="py-1 px-2 text-right"><?= ($breed) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Edad</th>
                                                    <td class="py-1 px-2 text-right"><?= ($age) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Servicio(s) necesario(s)</th>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
									...
									switch ($status){
										case 0:
											echo '<span class="ml-4 rounded-pill badge badge-primary">Pendiente</span>';
											break;
										case 1:
											echo '<span class="ml-4 rounded-pill badge badge-success">Confirmada</span>';
											break;
										case 2:
											echo '<span class="ml-4 rounded-pill badge badge-danger">Cancelada</span>';
											break;
									}
								?>
                                </div>
                ...
                <div class="rounded-0 text-center mt-3">
                        <a class="btn btn-sm btn-primary btn-flat" href="javascript:void(0)" id="update_status"><i class="fa fa-edit"></i> Estado Actual</a>
                        <button class="btn btn-sm btn-danger btn-flat" type="button" id="delete_data"><i class="fa fa-trash"></i> Eliminar</button>
                        <a class="btn btn-light border btn-flat btn-sm" href="./?page=appointments" ><i class="fa fa-angle-left"></i> Volver a la lista</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(function(){
        $('#delete_data').click(function(){
			_conf("¿Estás seguro de eliminar <b><?= $code ?>\'s</b> la cita permanentemente?","delete_appointment",['<?= $id ?>'])
		})
