...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Lista de Categoria <small><em>(Tipos de mascotas)</em></small></h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Agregar Categoria</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Agregar Nueva Categoria","categories/manage_category.php")
		})
        $('.edit_data').click(function(){
			uni_modal("Update Category Details","categories/manage_category.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar this Category permanently?","delete_category",[$(this).attr('data-id')])
		})
