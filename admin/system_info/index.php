...
<div class="col-lg-12">
	<div class="card card-outline card-dark rounded-0 shadow">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Logotipo del sistema</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Imagen de Fondo</label>
				<div class="custom-file">
			...
			<fieldset>
				<legend>Información de Citas</legend>
				<div class="form-group">
					<label for="max_appointment" class="control-label">Máximo de pacientes al día</label>
				...
				<div class="form-group">
					<label for="clinic_schedule" class="control-label">Horario diario de la clínica <small><em>Ejemplo: (8:00 AM - 5:30 PM)</em></small></label>
