...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Agregar Servicio</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Agregar Nuevo Servicio","services/manage_service.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal("Actualizar detalles del servicio","services/manage_service.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar este servicio de forma permanente?","delete_service",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Detalles del Servicio","services/view_service.php?id="+$(this).attr('data-id'),'mid-large')
		})
