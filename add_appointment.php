...
<div class="container-fluid">
    <form action="" id="appointment-form">
        ...
        <div class="row">
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Información del propietario</legend>
                    <div class="form-group">
                        <label for="owner_name" class="control-label">Nombre y Apellido</label>
                        <input type="text" name="owner_name" id="owner_name" class="form-control form-control-border" placeholder="Nombre y Apellido" value ="<?php echo isset($owner_name) ? $owner_name : '' ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control form-control-border" placeholder="Correo Electrónico" value ="<?php echo isset($email) ? $email : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="address" class="control-label">Dirección</label>
                        <textarea type="email" name="address" id="address" class="form-control form-control-sm rounded-0" rows="3" placeholder="Ciudad, Barrio, Dirección de Residencia" required><?php echo isset($address) ? $address : '' ?></textarea>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Información de mascotas</legend>
                    <div class="form-group">
                        <label for="category_id" class="control-label">Tipo de mascota</label>
                    ...
                    <div class="form-group">
                        <label for="breed" class="control-label">Raza de mascota</label>
                        <input type="text" name="breed" id="breed" class="form-control form-control-border" placeholder="Labrador retriever, Bulldog, Pug, Gato" value ="<?php echo isset($breed) ? $breed : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="age" class="control-label">Edad de la mascota</label>
                        <input type="text" name="age" id="age" class="form-control form-control-border" placeholder="# Años" value ="<?php echo isset($age) ? $age : '' ?>" required>
                    </div>
                </fieldset>
                <div class="form-group">
...
<script>
    ...
    $(function(){
        $('#uni_modal').on('shown.bs.modal',function(){
            $('#category_id').select2({
                placeholder:"Seleccione el tipo de mascota aquí.",
                width:'100%',
                dropdownParent:$('#uni_modal')
            })
            $('#service_id').select2({
                placeholder:"Seleccione el(los) servicio(s) aquí.",
                width:'100%',
                dropdownParent:$('#uni_modal')
            })
        })
